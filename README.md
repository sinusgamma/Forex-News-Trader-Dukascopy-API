...
A trading example in test environment, CLICK THE IMAGE:
[![PROMOTRADE](https://github.com/sinusgamma/Forex-News-Trader-Dukascopy-API/blob/master/example_data_files/promotrade.JPG)](https://youtu.be/OlUAhYJyn_k)
...
## Parameter selection:
https://www.kaggle.com/sinusgamma/forex-strategy-eda-and-parameter-selection
https://github.com/sinusgamma/FOREX-strategy-parameter-selection/blob/master/forex-strategy-eda-and-parameter-selection.ipynb
